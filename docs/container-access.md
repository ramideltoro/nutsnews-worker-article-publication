...
Image: `ghcr.io/ramideltoro/nutsnews-worker-article-publication:<commit-sha>`

The publish workflow builds, signs, and pushes immutable SHA-tagged images. It does not publish mutable `latest` tags.
